...
test('Code should be 0 for valid signature', async () => {
    ...
    expect(result.stdout).toBe("Signature is correct\n");
})
...
test('Code should be 1 for invalid signature', async () => {
    ...
    expect(result.stdout).toBe("Signature is incorrect\n");
})

test('Invalid signature format should not lead to crash', async () => {
    let result = await cli(['02849ff0f6bb5156afe079457f68103ffa46ea1ef15652b90e327230d93e2d1c211', 'testtest', '304602210084cdfa969e1789855db5e5ccb811s9b367a5d17b45bed5688bf4cc76e89a4a1d5022100a0c566fde5894e93a60d5bf717739b2bc29da108f928b0c22b5541a5508f9e87'], '.');
    expect(result.code).toBe(2);
    expect(result.stdout).toBe("Invalid signature\n");
})
